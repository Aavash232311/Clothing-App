...
function Nav() {
  ...
  // const { user, logOut, logIn } = useAuth(); // later imp
  let length = 0;
  if (items.length > 0) {
  ...
  const CartIconAndFunctionality = () => {
    return (
      <NavItem>
        <NavLink tag={Link} to={"/chittychittybangbang"}>
          {items.length > 0 ? (
            ...
            >
              <Badge badgeContent={length} color="secondary" overlap="circular">
          ...
          {(value) => {
            return (
              <>
                ...
                {search === true ? (
                  <>
                    <div style={{listStyle: "none"}}  id="searchExpand">
                      <NavItem>
                        <NavLink tag={Link} to="/">
                          <div id="bottom-nav-left">
                            <img
                      ...
                      <center>
                        <input id="actual-search" placeholder="Search"></input>
                      </center>
                    </div>
                  </>
                ) : null}
                <div id="mobile-bottom">
                  <div className="grid-trim">
                    <CartIconAndFunctionality />
                  </div>
                  <div className="grid-trim">
                    <NavItem>
